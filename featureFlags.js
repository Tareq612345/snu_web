...
export const FEATURE_KEYS = Object.freeze(['privateMessages','generalChat','studyChat','helpChat','randomChat','socialFeed','follows','leaderboard','xp','achievements','streak','aiAssistant','videoCalls']);
export const OFFICIAL_MODE_DEFAULTS = Object.freeze({privateMessages:false,generalChat:false,studyChat:false,helpChat:false,randomChat:false,socialFeed:false,follows:false,leaderboard:false,xp:false,achievements:false,streak:true,aiAssistant:true,videoCalls:false});
